...
class _MyAppState extends State<MyApp> {
  ...
  void toggleLanguage(BuildContext context) {
    ...
    final newLocale = locale.languageCode == 'en' ? Locale('id') : Locale('en');
    setState(() {
      _locale = newLocale;
    });
  }
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        home: Builder(
          builder: (context) {
            return RegisterPage(toggleLanguage: () => toggleLanguage(context));
          },
        ),
      ),
    );
...
class RegisterPage extends StatelessWidget {
  const RegisterPage({super.key, required this.toggleLanguage});
